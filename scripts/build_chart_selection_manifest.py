...
POSITIVE_SELECTION_QUESTIONS: dict[str, str] = {
    ...
    "period_comparison.by_period": "How do weekly-average AC/PY sales gaps differ across overlapping 52-, 26-, 13- and 4-week recency windows?",
...
DECISION_CUES_BY_EMPHASIS: dict[str, dict[str, Any]] = {
    ...
    "period_by_period_gap": {
        "primary_decision_cue": "Question asks for weekly-average current-vs-baseline gaps across overlapping recency windows, not individual calendar months.",
        "requires_question_focus": ["period_gap", "current_vs_baseline_by_period"],
        "reject_decision_cues": [
            "asks for individual calendar-month totals",
...
CAPABILITY_SEMANTICS: dict[str, dict[str, Any]] = {
    ...
    "period_comparison.by_period": _cap(
        ...
        best_when="The reader needs weekly-average current and baseline values across overlapping 52-, 26-, 13- and 4-week recency windows.",
        avoid_when="Do not use for individual calendar-month totals or monthly gaps; use multitier_column for side-by-side monthly values or trend for their trajectory. Recency windows overlap and are not additive.",
        axis_roles={
            "x": "overlapping_recency_window",
            "y": "weekly_average_metric",
            "series": "scenario_or_comparison_period",
        },
        period_role="axis",
        metric_roles=[
