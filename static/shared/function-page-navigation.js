(() => {
  ...
  const areaLabels = {
    vera: {
      ...
      "area-studio": {
        it: "Ricerca, comunicazione e sviluppo dello studio",
        en: "Research, communication, and firm development",
        fr: "Recherche, communication et développement du cabinet",
        de: "Recherche, Kommunikation und Kanzleientwicklung",
        es: "Investigación, comunicación y desarrollo del despacho",
      },
    },
    lucia: {
      "area-research": {
  ...
  const pageContexts = {
    ...
    "bandi-agevolazioni": [["vera", "area-studio"]],
    ...
    "deep-research-validator": [["lucia", "area-research"], ["vera", "area-studio"]],
    ...
    "prompt-optimizer": [["lucia", "area-research"], ["vera", "area-studio"]],
    "quesito-legale-fiscale": [["lucia", "area-research"], ["vera", "area-studio"]],
