(() => {
  ...
  const areaLabels = {
    vera: {
      ...
      "area-clients": {
        ...
        fr: "Clients, missions et documents",
        de: "Mandanten, Aufträge und Dokumente",
        es: "Clientes, encargos y documentos",
      },
      "area-matters": {
        it: "Pratiche e adempimenti",
        en: "Matters and compliance",
        fr: "Dossiers et obligations",
        de: "Verfahren und Pflichten",
        es: "Expedientes y obligaciones",
      },
      "area-accounting": {
        it: "Controlli e riconciliazioni",
        en: "Checks and reconciliations",
        fr: "Contrôles et rapprochements",
        de: "Kontrollen und Abstimmungen",
        es: "Controles y conciliaciones",
      },
      "area-analysis": {
        it: "Pianificazione, analisi e report",
        en: "Planning, analysis, and reporting",
        fr: "Planification, analyses et rapports",
        de: "Planung, Analyse und Berichte",
        es: "Planificación, análisis e informes",
      },
      "area-research": {
        it: "Ricerca legale, fiscale e opportunità",
        en: "Legal and tax research and opportunities",
        fr: "Recherche juridique, fiscale et opportunités",
        de: "Rechtliche und steuerliche Recherche sowie Fördermöglichkeiten",
        es: "Investigación jurídica, fiscal y oportunidades",
      },
      "area-studio": {
        it: "Comunicazione e presenza dello studio",
        en: "Communication and firm presence",
        fr: "Communication et présence du cabinet",
        de: "Kommunikation und Kanzleiauftritt",
        es: "Comunicación y presencia del despacho",
      },
    },
    lucia: {
      "area-practice": {
        it: "Pratiche dello studio",
        en: "Practice workflows",
        fr: "Parcours de pratique",
        de: "Mandatsabläufe",
        es: "Recorridos de práctica",
      },
      "area-documents": {
  ...
  const pageContexts = {
    ...
    "controllo-documento": [["lucia", "area-documents"]],
    "estrazione-clausole": [["lucia", "area-documents"]],
    "revisione-word": [["lucia", "area-documents"]],
    "metodo-studio": [["lucia", "area-documents"]],
    "verifica-citazioni": [["lucia", "area-research"]],
    "contenzioso-civile": [["lucia", "area-practice"]],
    "operazioni-ma": [["lucia", "area-practice"]],
    "lavoro": [["lucia", "area-practice"]],
    "recupero-crediti": [["lucia", "area-practice"]],
    "lucia-mike": [["lucia", "core"]],
    ...
    "fatture-xml-check": [["vera", "area-matters"]],
    "financial-analysis": [["vera", "area-analysis"]],
    ...
    "new-client/zurich": [["vera", "area-clients"]],
    "presenza-digitale-studio": [["lucia", "area-studio"], ["vera", "area-studio"]],
