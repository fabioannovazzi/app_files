# One investment, two assumptions to test
...
Fictional Arco considers a subscription service with 100 average paying customers at EUR 50 per month and EUR 42,000 annual costs. The price is a team proposal; demand evidence consists of five exploratory interviews, not orders.

Clara, help me understand which assumptions make this service sustainable.

## 2. The starting evidence · 60 s

Look at the documents in the other chat. Find one useful fact and one missing item.

P1 and P2 are explicit assumptions. P3 explores needs without proving that 100 customers will subscribe.

[["Average paying customers", "100", "P1 · team assumption"], ["Monthly price", "EUR 50", "P1 · proposal"], ["Annual costs", "EUR 42,000", "P2 · operating estimate"], ["Exploratory interviews", "5", "P3 · notes; no orders"]]

## 3. How the workflow works · 75 s

Follow the three steps. Pause at the decision that changes the result.

Define the decision and separate evidence, accepted assumptions and information still needed.
Build the current plan with coherent customers, prices, costs and timing. Link assumptions to sources and distinguish economic results from cash.
Compare useful scenarios and present the decision, sensitivities and evidence-gathering actions for professional review.

## 4. Read the result · 90 s

Open the example in the second chat. Connect each conclusion to its source.

The base scenario produces EUR 60,000 annual revenue and EUR 18,000 above the stated costs. At 70 customers, that difference is zero.

[["100 average customers", "EUR 60,000", "EUR 18,000"], ["70 average customers", "EUR 42,000", "EUR 0"]]

## 5. The check that matters · 75 s

Before revealing the answer, say what you would check.

These are conditional results, not net profit or cash. Interviews are not orders.

The arithmetic is correct. Can we confirm project viability?

Compare your reasoning: We can confirm the case arithmetic. Demand evidence and a complete cost, investment and collection-timing plan are still needed.

## 6. Try it together · 45 s

Choose whether to try now or keep the example for your next assignment.

Reduce the price to EUR 45 and compare scenarios with the changed assumption visible.

Choose a concrete investment and collect quotations, commercial evidence and assumptions to discuss.
