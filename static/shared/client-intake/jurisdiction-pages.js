(() => {
  ...
  const interfaceCopy = {
    it: {
      ...
      outputs: {
        ...
        tableAria: "Risultati dell'istruttoria cliente",
      ...
      video: {
        ...
        thumbnailAlt: "Anteprima della guida video sull'istruttoria cliente",
      },
      next: {
        eyebrow: "Passaggio successivo",
        title: "Trasforma il dossier in un rapporto di lavoro.",
        copy:
          "Report Builder riprende tabelle, memo e fonti e prepara un documento Word strutturato.",
        button: "Scopri Report Builder",
      },
      download: {
    ...
    en: {
      ...
      outputs: {
        ...
        tableAria: "Client intake outputs",
      ...
      video: {
        ...
        thumbnailAlt: "Preview of the client intake video guide",
      },
      next: {
        eyebrow: "Next step",
        title: "Turn the work pack into a working report.",
        copy:
          "Report Builder carries the tables, memo and sources into a structured Word document.",
        button: "Explore Report Builder",
      },
      download: {
    ...
    fr: {
      ...
      outputs: {
        ...
        tableAria: "Livrables de l'instruction client",
      ...
      video: {
        ...
        thumbnailAlt: "Aperçu du guide vidéo sur l'instruction client",
      },
      next: {
        eyebrow: "Étape suivante",
        title: "Transformez le dossier en rapport de travail.",
        copy:
          "Report Builder reprend les tableaux, le mémo et les sources pour préparer un document Word structuré.",
        button: "Découvrir Report Builder",
      },
      download: {
        eyebrow: "Installation",
    ...
    de: {
      ...
      outputs: {
        ...
        tableAria: "Ergebnisse der Mandanten-Erstprüfung",
      ...
      video: {
        ...
        thumbnailAlt: "Vorschau der Videoanleitung zur Mandanten-Erstprüfung",
      },
      next: {
        eyebrow: "Nächster Schritt",
        title: "Aus der Akte wird ein Arbeitsbericht.",
        copy:
          "Report Builder übernimmt Tabellen, Notiz und Quellen und bereitet daraus ein strukturiertes Word-Dokument vor.",
        button: "Report Builder ansehen",
      },
      download: {
        eyebrow: "Installation",
  ...
  const jurisdictions = {
    geneva: {
      ...
      copy: {
        it: {
          metaTitle: "Istruttoria cliente · Ginevra | Vera",
          metaDescription:
          ...
          eyebrow: "Istruttoria cliente · Ginevra",
          ...
          installCopy:
            "Aggiungi i documenti in ChatGPT e chiedi a Vera di preparare la prima istruttoria fiscale di Ginevra.",
        },
        en: {
          metaTitle: "Client intake · Geneva | Vera",
          metaDescription:
          ...
          installCopy:
            "Add the records in ChatGPT and ask Vera to prepare the first Geneva tax intake.",
        },
        fr: {
          metaTitle: "Instruction client · Genève | Vera",
          metaDescription:
          ...
          eyebrow: "Instruction client · Genève",
          ...
          installCopy:
            "Ajoutez les pièces dans ChatGPT et demandez à Vera de préparer la première instruction fiscale genevoise.",
        },
        de: {
          metaTitle: "Mandanten-Erstprüfung · Genf | Vera",
          metaDescription:
          ...
          eyebrow: "Mandanten-Erstprüfung · Genf",
          ...
          heroCopy:
            "Nutzen Sie die Erstprüfung, wenn Nachweise als PDF, Bilder, Exporte oder gemischte Dateien eintreffen. Codex liest den Ordner lokal, erstellt das Inventar, kennzeichnet unklare Punkte und bereitet eine Kanzleinotiz mit E-Mail-Entwurf vor.",
          scopeInput:
    ...
    zurich: {
      ...
      copy: {
        it: {
          metaTitle: "Istruttoria cliente · Zurigo | Vera",
          metaDescription:
          ...
          eyebrow: "Istruttoria cliente · Zurigo",
          ...
          documents: {
            eyebrow: "Documenti",
            title: "Documenti ordinati dall'istruttoria",
            copy:
          ...
          installCopy:
            "Aggiungi i documenti in ChatGPT e chiedi a Vera di preparare la prima istruttoria fiscale di Zurigo.",
        },
        en: {
          metaTitle: "Client intake · Zurich | Vera",
          metaDescription:
          ...
          documents: {
            eyebrow: "Documents",
            title: "Documents organised by the intake",
            copy:
          ...
          installCopy:
            "Add the records in ChatGPT and ask Vera to prepare the first Zurich tax intake.",
        },
        fr: {
          metaTitle: "Instruction client · Zurich | Vera",
          metaDescription:
          ...
          eyebrow: "Instruction client · Zurich",
          ...
          installCopy:
            "Ajoutez les pièces dans ChatGPT et demandez à Vera de préparer la première instruction fiscale zurichoise.",
        },
        de: {
          metaTitle: "Mandanten-Erstprüfung · Zürich | Vera",
          metaDescription:
          ...
          eyebrow: "Mandanten-Erstprüfung · Zürich",
          title: "Mandanten-Erstprüfung für Zürcher Treuhänder",
          subtitle:
          ...
          heroCopy:
            "Nutzen Sie es, wenn Belege als gemischte PDF-Dateien, Bilder, Exporte und Nachweise eintreffen. Die Erstprüfung ordnet das Dossier, extrahiert lesbaren Text und bereitet eine Arbeitsunterlage für die weitere Bearbeitung vor.",
          scopeInput:
            "Mandantenordner mit PDF-Dateien, Bildern, Exporten und Belegen",
          scopeFocus: "Zürcher Steuerdossiers",
          documents: {
            eyebrow: "Unterlagen",
            title: "Unterlagen, die der Intake ordnet",
            copy:
    ...
    uk: {
      ...
      copy: {
        it: {
          ...
          eyebrow: "Istruttoria cliente · Regno Unito",
          title: "Istruttoria cliente per il Self Assessment",
          subtitle:
            "Prima lettura della cartella: documenti ricevuti, lacune da risolvere, memo dello studio ed email di seguito al cliente.",
          heroCopy:
            "Usalo quando il materiale del cliente arriva come PDF, immagini, estratti e giustificativi diversi. L'istruttoria classifica la cartella, estrae il testo leggibile e prepara un dossier di lavoro prima della compilazione o revisione della dichiarazione.",
          scopeInput:
            "Cartella cliente con PDF, immagini, estratti e giustificativi",
          ...
          documents: {
            ...
            title: "Documenti ordinati dall'istruttoria",
            copy:
              "L'istruttoria è costruita sulle famiglie di documenti che arrivano normalmente prima della preparazione del Self Assessment.",
            cards: [
              {
          ...
          installCopy:
            "Aggiungi i documenti in ChatGPT e chiedi a Vera di preparare la prima istruttoria Self Assessment del Regno Unito.",
        },
        en: {
          metaTitle: "Self Assessment client intake | Vera",
          metaDescription:
          ...
          eyebrow: "Client intake · United Kingdom",
          title: "Self Assessment client intake",
          subtitle:
          ...
          scopeFocus: "UK Self Assessment intake",
          documents: {
            eyebrow: "Documents",
            title: "Documents the intake organises",
            copy:
          ...
          installCopy:
            "Add the records in ChatGPT and ask Vera to prepare the first UK Self Assessment intake.",
        },
        fr: {
          ...
          eyebrow: "Instruction client · Royaume-Uni",
          title: "Instruction client pour le Self Assessment",
          subtitle:
            "Première revue du dossier : documents reçus, lacunes à résoudre, mémo cabinet et email de suivi au client.",
          heroCopy:
            "Utilisez-le quand les pièces du client arrivent sous forme de PDF, images, exports et justificatifs divers. L'instruction classe le dossier, extrait le texte lisible et prépare un dossier de travail avant la préparation ou la revue de la déclaration.",
          scopeInput:
            "Dossier client avec PDF, images, exports et justificatifs",
          ...
          documents: {
            ...
            title: "Documents ordonnés par l'instruction",
            copy:
              "L'instruction est conçue autour des familles de documents qui arrivent habituellement avant la préparation du Self Assessment.",
            cards: [
              {
          ...
          installCopy:
            "Ajoutez les pièces dans ChatGPT et demandez à Vera de préparer la première instruction Self Assessment au Royaume-Uni.",
        },
        de: {
          ...
          eyebrow: "Mandanten-Erstprüfung · Vereinigtes Königreich",
          title: "Mandanten-Erstprüfung für Self Assessment",
          subtitle:
          ...
          heroCopy:
            "Nutzen Sie die Erstprüfung, wenn Mandantenunterlagen als PDF-Dateien, Bilder, Exporte und gemischte Nachweise eintreffen. Sie klassifiziert den Ordner, extrahiert lesbaren Text und bereitet eine Arbeitsunterlage vor, bevor die Erklärung erstellt oder geprüft wird.",
          scopeInput:
  ...
  function setMetadata(page, pageCopy, language) {
    const canonicalUrl = `https://mparanza.com/static/shared/client-intake/${page.slug}`;
    ...
    main.innerHTML = `
      ...
      <section class="section-block" aria-labelledby="next-title">
        <div class="connected-panel">
          ...
          <a class="button" href="../report-builder/index.html?lang=${language}">${escapeHtml(
            ui.next.button,
          )}</a>
        </div>
      </section>
