...
- `archive-organization`: a client-bound workflow with local-folder support in
  Claude and Cowork, and Google Drive support when its declared connector is available, that
