    ...
    *,
    ...
    final_artifacts_path = _write_json(
        output_dir / "final_artifacts.json",
        {
            ...
            "caveats": [
                (
                    "Las coincidencias deterministas solo se aceptan conforme a las reglas del script; las filas sin conciliar requieren la interpretación explícita de Claude o de la persona revisora."
                    if spanish
                    else "Deterministic matches are accepted only by the script rules; unmatched rows require explicit Claude or reviewer interpretation."
                ),
                (
