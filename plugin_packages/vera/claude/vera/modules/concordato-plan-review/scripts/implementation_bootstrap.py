"""Pre-import execution boundary for assured Concordato commands.

The bootstrap uses only interpreter-provided modules before closing the exact
plugin and shared-assurance tree. Byte identity and set membership prove
execution/receipt consistency; they do not authenticate the package, a
professional reviewer, or any accounting, legal, or tax conclusion.
"""
...
IMPLEMENTATION_CONTRACT = (
    ...
    ("plugin", ".app.json"),
    ("plugin", ".mcp.json"),
    ("plugin", "assets/concordato-plan-review-widget.html"),
    ...
    ("plugin", "scripts/replay_assurance.py"),
    ("plugin", "scripts/review_case_model.py"),
    ("plugin", "scripts/review_session.py"),
    ("plugin", "scripts/review_source_roles.py"),
