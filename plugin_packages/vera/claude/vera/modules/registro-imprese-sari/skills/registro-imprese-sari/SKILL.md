...
2. Show a Run Intake table with the stable case reference, private input
   and output folders, competent Camera, reference/effective dates, Claude-context
...
Real case material may enter the Claude model context when it is useful for this
...
## 5. Author the plan with Claude

Claude reads the confirmed case facts and selected source artifacts, then writes
