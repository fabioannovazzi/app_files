...
def package_practice(output_dir: Path) -> dict[str, Any]:
    ...
    handoff_lines = (
        [
            ...
            "2. Abra la revisión profesional en Claude con `render_registro_imprese_sari_review`.",
        ...
        if language == "es"
            ...
            "2. Open the professional review in Claude with `render_registro_imprese_sari_review`.",
