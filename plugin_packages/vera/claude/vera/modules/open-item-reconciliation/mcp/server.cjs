  ...
  return [
    {
      ...
      description:
        "Validate the Open-item Reconciliation review-session payload before optional MCP rendering. Call this first, then render_open_item_reconciliation_review when using the integrated Claude surface.",
      inputSchema,
      annotations: {
        readOnlyHint: true,
