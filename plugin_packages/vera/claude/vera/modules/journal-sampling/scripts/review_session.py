...
_REVIEW_COPY: dict[str, dict[str, Any]] = {
    "en": {
        ...
        "caveats": [
            ...
            "evidence set.",
            "ui_decisions.json is pending until Claude, the MCP widget, or fallback review "
            "records decisions.",
        ],
        "next_actions": [
    ...
    "es": {
        ...
        "dependency_note": "Claude debe ejecutar scripts/check_dependencies.py antes de los scripts "
        "auxiliares.",
        "data_posture_notes": [
        ...
        "caveats": [
            ...
            "ui_decisions.json permanece pendiente hasta que Claude, el widget MCP o la "
    ...
    "it": {
        ...
        "dependency_note": "Claude deve eseguire scripts/check_dependencies.py prima degli script "
        "operativi.",
        "data_posture_notes": [
        ...
        "caveats": [
            ...
            "ui_decisions.json resta in sospeso finché Claude, il widget MCP o la revisione "
    ...
    "fr": {
        ...
        "review_in_codex": "Révision dans Claude",
        ...
        "dependency_note": "Claude doit exécuter scripts/check_dependencies.py avant les scripts "
        "opérationnels.",
        "data_posture_notes": [
        ...
        "caveats": [
            ...
            "Claude, le widget MCP ou la révision alternative.",
        ],
        "next_actions": [
    ...
    "de": {
        ...
        "dependency_note": "Claude muss scripts/check_dependencies.py vor den Arbeitsskripten "
        "ausführen.",
        "data_posture_notes": [
        ...
        "caveats": [
            ...
            "Nachweisbestand.",
            "ui_decisions.json bleibt ausstehend, bis Claude, das MCP-Widget oder die "
