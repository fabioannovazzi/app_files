#!/usr/bin/env python3
"""Calculate and render one reviewed Vera Startup Business Plan case."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        load_client_engagement_context_file(
            ...
            expected_workflow_id="startup-business-plan",
    ...
    receipt = {
        "schema_version": "vera.startup_business_plan_execution_receipt.v1",
        "workflow_id": "startup-business-plan",
        "status": plan["status"],
    ...
    LOGGER.info("Wrote Startup Business Plan package with status %s.", plan["status"])
