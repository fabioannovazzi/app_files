    ...
    *,
    ...
    copy = {
        ...
        "es": {
            ...
            "missing": "# Documentos pendientes o inciertos",
    ...
    _append_if_text(required["07_scheda_per_studio.md"], first_missing)
    _append_if_text(
        required["07_scheda_per_studio.md"], first_professional_question
    )
    _append_if_text(required["07_scheda_per_studio.md"], first_client_question)
...
def write_review_session_artifacts(
    ...
    *,
    ...
    manifest_copy = {
        "it": {
            "caveat": "ui_decisions.json resta in attesa finché una revisione professionale, l’interfaccia locale o il fallback non registra le decisioni.",
        ...
        "en": {
            "caveat": "ui_decisions.json remains pending until a professional review, local interface, or fallback records reviewer decisions.",
        ...
        "fr": {
            "caveat": "ui_decisions.json reste en attente jusqu’à ce qu’une revue professionnelle, l’interface locale ou le mode de secours enregistre les décisions.",
        ...
        "de": {
            "caveat": "ui_decisions.json bleibt ausstehend, bis eine professionelle Prüfung, die lokale Oberfläche oder der Fallback Entscheidungen erfasst.",
        ...
        "es": {
            "caveat": "ui_decisions.json permanece pendiente hasta que una revisión profesional, la interfaz local o el modo alternativo registren las decisiones.",
