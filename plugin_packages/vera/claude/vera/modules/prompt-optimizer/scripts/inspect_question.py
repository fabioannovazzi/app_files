"""Inspect a legal/tax/compliance question before Claude optimizes the prompt."""
...
def source_domains_for_question(
    ...
    *,
    ...
    Source-domain curation is a legal relevance judgment and belongs to Claude's
...
def _prompt_recipe(inventory: QuestionInventory, language: str) -> dict[str, Any]:
    """Return a deterministic prompt recipe for Claude to fill."""
