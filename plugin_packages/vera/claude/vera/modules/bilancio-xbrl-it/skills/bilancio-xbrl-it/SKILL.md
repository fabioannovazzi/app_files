...
Real case data may enter the selected Claude or Cowork model context. Do not
...
Claude and Cowork must use the same `intelligence_contract.py` packet builders
...
checksums, and residual professional-review items. Create `run_review.md`
