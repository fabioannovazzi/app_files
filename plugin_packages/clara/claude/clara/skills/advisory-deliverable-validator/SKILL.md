...
## Claude, Claude and Cowork

In Cowork, use the packaged workflow and, when local execution is
...
When a run creates persistent artifacts, also write `run_review.md` with
