"""Mechanical helpers for the Clara Claude plugin."""
...
def _summarize_file(path: Path) -> str:
    ...
    if suffix == ".pdf":
        return "PDF indexed; semantic review remains in Claude."
    if suffix == ".pptx":
        try:
...
def add_judgement_entries(
    ...
    *,
    ...
    """Store Claude-structured judgement entries with explicit review status."""
...
def prepare_clara_kickoff(
    ...
    *,
    ...
    This is deterministic preparation. Claude may browse public or authorized
...
def _indexed_industry_context_items(
    ...
    for material in materials:
        ...
        if not summary or summary in {
            ...
            "PDF indexed; semantic review remains in Claude.",
        }:
            continue
...
def _case_brief_copy(manifest: Mapping[str, Any]) -> dict[str, Any]:
    if _ui_language(manifest) == "es":
        return {
            ...
            "inferences": "Inferencias de Claude",
            ...
            "no_inferences": (
                "Aún no hay inferencias de Claude listas para el paquete de decisión."
            ),
            "no_decisions": (
            ...
            "kind_labels": {
                ...
                "codex_inference": "inferencia de Claude",
    ...
    return {
        ...
        "no_inferences": "No decision-pack-ready Claude inferences yet.",
...
def apply_inclusion_bundles(
    ...
    *,
    ...
    """Persist semantic inclusion-review bundles supplied by Claude/Clara.
...
def _inclusion_review_copy(language: str) -> dict[str, str]:
    if language == "it":
        return {
            ...
            "create_bundles": (
                "Per revisioni lunghe, Clara/Claude puo' creare "
    ...
    if language == "es":
        return {
            ...
            "create_bundles": (
                "Para revisiones largas, Clara/Claude puede crear "
    ...
    return {
        ...
        "create_bundles": (
            "For long reviews, Clara/Claude can create `inclusion_bundles.json` "
