...
description: Use when a user wants Claude to turn a CSV plus explicit ordered stages into a deterministic funnel-stage reporting table with start, pass, drop-off, stage conversion, cumulative conversion, context JSON, and artifact manifest.
---
...
Claude supplies explicit material choices, then the scripts evaluate predicates,
