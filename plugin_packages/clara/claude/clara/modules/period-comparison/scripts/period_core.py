"""Period-comparison chart helpers for the Claude plugin."""
...
from modules.reporting_table import (
    _table_value_scale,
)
from modules.reporting_table import (  # noqa: E402
    write_reporting_table as _render_reporting_table_html,
)
