...
description: Use when a user wants Claude to inspect a CSV/XLSX file, generate legacy histogram, boxplot, stripplot, ECDF, kernel-density charts, small multiples, and distribution-shape source data.
---
...
audit, context, summary, and any `run_review.md` note.
...
path. Claude should interpret the prepared numbers, context JSON, tables, audits,
