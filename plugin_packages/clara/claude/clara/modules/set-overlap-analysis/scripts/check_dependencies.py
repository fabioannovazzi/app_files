"""Dependency checker for the set-overlap-analysis plugin."""
...
def configure_matplotlib_cache() -> None:
    """Point Matplotlib at a writable cache directory before import."""
...
def collect_import_warnings(module_name: str) -> list[str]:
    """Import one module and return warnings raised during import."""
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Check runtime dependencies for the set-overlap-analysis plugin."
    )
