# Institutional discovery in Codex and ChatGPT
...
scripts and retain private artifacts. In Codex or ChatGPT with those capabilities,
...
Repeat the same scenario in both Codex and ChatGPT and retain the normal answer,
