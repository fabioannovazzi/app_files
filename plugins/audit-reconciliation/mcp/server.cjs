  ...
  return [
    {
      ...
      description:
        "Validate the Audit Reconciliation review-session payload before optional MCP rendering. Call this first, then render_audit_reconciliation_review when using the integrated Codex surface.",
      inputSchema,
      annotations: {
        readOnlyHint: true,
