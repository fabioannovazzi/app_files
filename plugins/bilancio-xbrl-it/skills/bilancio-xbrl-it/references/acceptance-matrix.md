...
| Controlled official-taxonomy run | `PROVED_LOCAL` | 24/24 pass on 2026-08-06; 20/20 public-lifecycle XBRL workflows pass; corrected first-year case has a current-only source and no comparative fact/context; four boundary passes; eight non-cash schedule cases complete the controlled taxonomy adapter; checksums in `references/taxonomy-spike.md` | External TEBENI/rendering comparison is open |
