    ...
    with _lock(output):
        ...
        _write(
            output / "run_intake.json",
            {
                ...
                "sources": sources,
                "model_data": "Local scripts make no model or network calls. The selected Codex/Cowork runtime may read client tables, invoice evidence and review records to perform the professional task; no automatic anonymization.",
            },
        )
