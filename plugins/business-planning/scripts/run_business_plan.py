#!/usr/bin/env python3
"""Run the shared Business Planning workflow with Vera as visible owner."""
...
def main(argv: list[str] | None = None) -> int:
    """Keep Vera's Studio Archive boundary and shared authoritative compiler."""
    return run("Vera", argv)
