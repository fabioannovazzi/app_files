...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if args.counterpart_contribution is not None:
            input_paths.append(args.counterpart_contribution)
        load_client_engagement_context_file(
    ...
    receipt = {
        "schema_version": "mparanza.business_planning_financial_execution_receipt.v3",
        "workflow_id": "business-planning",
        "status": plan["status"],
        ...
        "implementation_reason": (
            ...
            "mechanically verifiable and must replay exactly. Counterpart checks claim "
            "only mechanical compatibility; semantic agreement remains professional."
        ),
    }
