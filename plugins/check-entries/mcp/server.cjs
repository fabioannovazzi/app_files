...
function callTool(name, args = {}) {
  if (name === TOOL_NAMES.validateReview) {
    ...
    return {
      ...
      message: "Check Entries review payload is valid. It is safe to call render_check_entries_review once.",
  ...
  throw new Error(`unknown Check Entries widget tool: ${name}`);
}
