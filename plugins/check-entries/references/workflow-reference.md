...
Codex can inspect outputs and explain professional conclusions, but it must not
...
Codex may prepare these objects after a reviewer makes the judgment, but must
