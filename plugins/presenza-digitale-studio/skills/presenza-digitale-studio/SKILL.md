...
After substantive use of this workflow, read and follow the `Plugin Improvement Feedback` section in `../vera/SKILL.md`. When this skill is
...
propose. When useful, save the visible run summary as `codex_run_review.md`
