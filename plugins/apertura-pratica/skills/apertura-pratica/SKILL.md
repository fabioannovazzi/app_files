...
In Codex, prefer the durable Studio Archive client/engagement lifecycle exposed
...
5. Maintain `codex_run_review.md` as the compact human-readable progress and
...
Mparanza automatically. Record only concrete friction, missing instructions or
unsafe ambiguity observed during this run; never include client facts, party
identities, matter documents, credentials or session material.
