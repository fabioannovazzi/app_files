"""Dependency checker for the scatter-bubble-analysis plugin."""
...
def configure_numba_cache() -> None:
    cache_dir = Path(tempfile.gettempdir()) / "mparanza-numba-cache"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Check runtime dependencies for the scatter-bubble-analysis plugin."
    )
...
def main(argv: list[str] | None = None) -> int:
    """Check runtime imports and write a JSON diagnostic when requested."""
