...
description: Use when a user wants Codex to inspect a sales or management-accounting CSV/XLSX file, compare scenarios or periods, run amount or price-volume-mix variance calculations, and produce reviewable plots and interpretation.
---
...
- `root_cause_review`: `status: approved`, the explicitly selected alternative, reviewer, timestamp, and rationale after Codex or the professional compares the sweep alternatives.
