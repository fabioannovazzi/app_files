...
function toolUiMeta(resourceUri, toolName = null) {
  ...
  if (toolName === TOOL_NAMES.renderReview) {
    meta["openai/toolInvocation/invoking"] = "Rendering Mix Contribution review";
    meta["openai/toolInvocation/invoked"] = "Rendered Mix Contribution review";
  }
  return meta;
}
...
function saveDecisionPayload(inputArgs) {
  ...
  return {
    ...
    message: persisted
      ? `Saved ${uiDecisions.decision_count} Mix Contribution decisions.`
...
function applyDecisionPayload(inputArgs) {
  ...
  return {
    ...
    message: persisted
      ? `Applied ${responseAppliedDecisions.decision_count} Mix Contribution decisions.`
