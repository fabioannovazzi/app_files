...
Place compact source IDs in the footer of substantive slides. The footer proves
reference closure, not semantic support. Generate a self-contained HTML gallery
...
layout, and divergence from the accepted story. Long unbroken tokens must wrap
