...
def main() -> int:
    ...
    message = (
        f"Lucia local tutorial status: {phase}. Onboarding is optional. "
        ...
        "For that tutorial read skills/lucia/references/local-onboarding.md and "
        "skills/learn-with-lucia/SKILL.md. Preserve saved progress and validate "
