...
def main() -> int:
    ...
    message = (
        f"Lucia local onboarding: {phase}. When Lucia is invoked, read "
        "skills/lucia/references/local-onboarding.md before routing professional work. "
        "Load the shared local profile explicitly. For teaching requests use "
        "skills/learn-with-lucia/SKILL.md and local_teaching.py status. "
