...
def main() -> int:
    ...
    message = (
        f"Clara local tutorial status: {phase}. Onboarding is optional. "
        ...
        "For that tutorial read skills/clara/references/local-onboarding.md and "
        "skills/learn-with-clara/SKILL.md. Preserve saved progress and validate "
