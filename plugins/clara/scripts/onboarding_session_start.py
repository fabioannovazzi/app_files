...
def main() -> int:
    ...
    message = (
        f"Clara local onboarding: {phase}. When Clara is invoked, read "
        "skills/clara/references/local-onboarding.md before routing professional work. "
        "Load the shared local profile explicitly. For teaching requests use "
        "skills/learn-with-clara/SKILL.md and local_teaching.py status. "
