...
def _codex_data_dir(plugin_root: Path) -> Path:
    """Return a stable user-private path that Codex permits runtime writes to."""
...
def _network_permission_detail(detail: str) -> str:
    """Tag mechanically identifiable network denial for a Codex approval retry."""
    ...
    return (
        ...
        "reached. In Codex, retry this exact managed-runtime command with host "
