...
The plugin turns long-form statement values plus an explicit calculation recipe
into a compact reporting table with grouped period/scenario columns and
deterministically computed subtotal and total rows. It does not call model APIs.
