...
[Source code](https://github.com/fabioannovazzi/app_files/tree/main/plugins/open-item-reconciliation) · [GNU AGPLv3 License](https://github.com/fabioannovazzi/app_files/blob/main/LICENSE)
...
- cliente e incarico selezionati in Studio Archive; ogni documento ricevuto va
  ...
  `open-item-reconciliation` va preparato con gli ID di quegli import e avviato;
...
- `validate_open_item_reconciliation_review` valida `review_payload.json` prima della resa.
- `render_open_item_reconciliation_review` apre il widget MCP `ui://widget/open-item-reconciliation-review.html` tramite `openai/outputTemplate`, utile come superficie integrata Codex opzionale.
...
```json
"path": "./plugins/open-item-reconciliation"
```
