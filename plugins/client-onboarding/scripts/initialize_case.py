    ...
    *,
    ...
    payload: dict[str, Any] = {
        ...
        "client_intake_binding": {
            ...
            "reason": (
                "No reviewed Client Intake run is bound; evidence is recorded "
                "directly for this onboarding case."
            ),
            "evidence_ids": [],
        },
...
def initialize_case(
    ...
    *,
    ...
    """Create an owner-only editable onboarding intake outside the repository."""

    resolved_dir = ensure_private_output_directory(case_dir)
    target = resolved_dir / "onboarding_intake.json"
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="Initialize a private Vera client-onboarding case intake."
    )
