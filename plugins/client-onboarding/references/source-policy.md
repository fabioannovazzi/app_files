...
reference; Client Onboarding does not copy, merge, render, or populate them.
...
Only these runtime source records may appear in a client review. The Francesco
prototype, MandatoProfessionale site, and ANC pricing page are kept separately
in `research-provenance.json` as non-runtime product inspiration. They are never
loaded as authority, used as a tariff, included in a client source list, or
treated as redistributable text.
