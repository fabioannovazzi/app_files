...
The plugin turns a CSV plus an explicit stage recipe into a compact reporting
table with starting population, passing population, drop-off, stage conversion,
and cumulative conversion. It does not call model APIs.
