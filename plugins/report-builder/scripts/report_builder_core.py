...
DOCX_COPY: dict[str, dict[str, str]] = {
    ...
    "audit_narrative": {
        "en": "Codex supplies the report commentary; the workflow calculates the reviewed figures.",
        "it": "Codex prepara i commenti del report; il workflow calcola le cifre verificate.",
        "fr": "Codex prépare les commentaires du rapport ; le workflow calcule les chiffres vérifiés.",
        "de": "Codex erstellt die Berichtskommentare; der Workflow berechnet die geprüften Zahlen.",
        "es": "Codex prepara los comentarios del informe; el workflow calcula las cifras verificadas.",
    },
    "audit_review": {
