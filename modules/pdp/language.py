...
PAGE_COPY: Dict[str, Dict[str, Any]] = {
    ...
    "research_validate": {
        "page_help": {
            ...
            "fr": "Examinez la réponse en extrayant un petit ensemble d'allégations clés, en vérifiant les sources citées et en décidant si chaque allégation est étayée et logiquement solide.",
            "de": "Prüfen Sie die Antwort, indem Sie eine kleine Zahl zentraler Aussagen extrahieren, die zitierten Quellen kontrollieren und beurteilen, ob jede Aussage belegt und logisch stimmig ist.",
        },
        "panels": {
            "input": {
                "title": {
                    ...
                    "fr": "Coller ou téléverser la sortie de Deep Research",
                    "de": "Deep-Research-Ergebnis einfügen oder hochladen",
                },
                "subtitle": {
                    ...
                    "fr": "Collez la réponse complète ou importez le PDF exporté depuis Deep Research.",
                    "de": "Füge die vollständige Antwort ein oder lade das aus Deep Research exportierte PDF hoch.",
                },
            },
            "results": {
                "title": {
                ...
                "subtitle": {
                    ...
                    "fr": "Passez en revue les allégations signalées, le prompt de correction et les notes finales.",
                    "de": "Prüfe markierte Aussagen, Korrektur-Prompt und abschließende Hinweise.",
                },
            },
            "prompt": {
                "title": {
                    "en": "Correction prompt",
                    "it": "Prompt di correzione",
                    "fr": "Prompt de correction",
                    "de": "Korrektur-Prompt",
                },
            },
            "coherence": {
                "title": {
                    ...
                    "fr": "Synthèse de cohérence",
                    "de": "Kohärenzzusammenfassung",
                },
            },
        },
        "buttons": {
            "choose_file": {
                ...
                "fr": "Sélectionner un fichier Deep Research",
                "de": "Deep-Research-Datei auswählen",
            },
            "run_validation": {
                "en": "Run verification",
                "it": "Avvia verifica",
            ...
            "confirm_edits": {
                ...
                "fr": "Confirmer les sélections",
                "de": "Auswahl bestätigen",
            },
            "generate_validated": {
                "en": "Generate validated document",
                "it": "Genera documento validato",
                "fr": "Générer le document validé",
                "de": "Validiertes Dokument erzeugen",
            },
            "download_docx": {
                "en": "Download validated docx",
                "it": "Scarica docx validato",
                "fr": "Télécharger le docx validé",
                "de": "Validiertes DOCX herunterladen",
            },
            "locate_claim_source": {
                "en": "Find in original text",
                "it": "Trova nel testo originale",
                "fr": "Trouver dans le texte source",
                "de": "Im Originaltext finden",
            },
            "clear_located_passage": {
                "en": "Clear highlight",
                "it": "Rimuovi evidenziazione",
                "fr": "Effacer la mise en évidence",
        ...
        "placeholders": {
            "research_input": {
                ...
                "fr": "Collez le texte de recherche, liens compris…",
                "de": "Füge den Recherchetext einschließlich Links ein…",
            },
        },
        "messages": {
            "upload_hint": {
                ...
                "fr": "Importez le PDF ou l'export Markdown pour préremplir la zone de texte.",
                "de": "Laden Sie das PDF oder den Markdown-Export hoch, um das Textfeld vorab zu füllen.",
            },
            "decisions_hint": {
                ...
                "fr": "Confirmez chaque problème pour contrôler ce qui entre dans le prompt de correction et le document fusionné.",
                "de": "Bestätigen Sie jedes Problem, um zu steuern, was in den Korrektur-Prompt und das zusammengeführte Dokument aufgenommen wird.",
            },
            "paste_first": {
                "en": "Please paste the research text first.",
                "it": "Incolla prima il testo della ricerca.",
                "fr": "Veuillez d'abord coller le texte de recherche.",
                "de": "Bitte füge zuerst den Recherchetext ein.",
            },
            ...
            "manual_fix_required": {
                ...
                "fr": "Aucun correctif suggéré : modifiez ou ignorez ce problème.",
                "de": "Kein Korrekturvorschlag verfügbar - bearbeiten oder ignorieren Sie dieses Problem.",
            },
            "claim_source_found": {
                "en": "Passage highlighted in the original text.",
                "it": "Passaggio evidenziato nel testo originale.",
                "fr": "Passage surligné dans le texte source.",
                "de": "Passage im Originaltext hervorgehoben.",
            },
            "claim_source_brought_into_view": {
                ...
                "fr": "Le passage a ete amene dans la zone visible ci-dessous et surligne dans le texte source.",
                "de": "Die Passage wurde unten sichtbar gemacht und im Originaltext hervorgehoben.",
            },
            "claim_source_not_found": {
                "en": "Passage not found in the original text.",
                "it": "Passaggio non trovato nel testo originale.",
                "fr": "Passage introuvable dans le texte source.",
                "de": "Passage im Originaltext nicht gefunden.",
            },
            "selection_missing": {
                "en": "Select an action for every issue.",
                "it": "Seleziona un'azione per ogni problema.",
                "fr": "Sélectionnez une action pour chaque problème.",
                "de": "Wählen Sie für jedes Problem eine Aktion aus.",
            },
            "edit_required": {
                "en": "Provide replacement text for edited issues.",
                "it": "Inserisci il testo sostitutivo per i problemi modificati.",
                "fr": "Fournissez un texte de remplacement pour les problèmes modifiés.",
                "de": "Geben Sie Ersatztext für bearbeitete Probleme ein.",
            },
            "no_claims": {
                "en": "No claims to confirm yet.",
                "it": "Nessuna affermazione da confermare.",
                "fr": "Aucune allégation à confirmer pour le moment.",
                "de": "Noch keine Aussagen zum Bestätigen vorhanden.",
            },
            "session_missing": {
                "en": "Start by running verification.",
                "it": "Avvia prima la verifica.",
                "fr": "Commencez par lancer la vérification.",
                "de": "Starten Sie zuerst die Prüfung.",
            },
            "saving_decisions": {
                "en": "Saving your selections...",
                "it": "Salvataggio selezioni in corso...",
                "fr": "Enregistrement des sélections...",
                "de": "Auswahl wird gespeichert...",
            },
            "decisions_saved": {
                ...
                "fr": "Sélections enregistrées. Vous pouvez maintenant télécharger le document validé.",
                "de": "Auswahl gespeichert. Sie können jetzt das validierte Dokument herunterladen.",
            },
            "download_paste_first": {
                "en": "Paste the research text before downloading.",
                "it": "Incolla il testo della ricerca prima di scaricare.",
                "fr": "Collez le texte de recherche avant de télécharger.",
                "de": "Füge den Recherchetext ein, bevor du herunterlädst.",
            },
            "download_after_confirm": {
                "en": "Confirm your issue selections before downloading.",
                "it": "Conferma le selezioni dei problemi prima di scaricare.",
                "fr": "Confirmez vos sélections de problèmes avant de télécharger.",
                "de": "Bestätigen Sie Ihre Problemauswahl vor dem Download.",
            },
            "download_started": {
                "en": "Downloading validated document…",
                "it": "Download del documento validato…",
                "fr": "Téléchargement du document validé…",
                "de": "Validiertes Dokument wird heruntergeladen…",
            },
            "verify_failed": {
        ...
        "labels": {
            "claim_number": {
                ...
                "fr": "Allégation n° {index}",
                "de": "Aussage Nr. {index}",
            },
            "claims_count": {
                "en": "Claims reviewed: {count}",
                "it": "Affermazioni esaminate: {count}",
                "fr": "Allégations analysées : {count}",
                "de": "Geprüfte Aussagen: {count}",
            },
            "flagged_issues_count": {
                "en": "Issues flagged: {count}",
                "it": "Problemi rilevati: {count}",
                "fr": "Problèmes signalés : {count}",
                "de": "Markierte Probleme: {count}",
            },
            "issue_count": {
                "en": "Issues: {count}",
                "it": "Problemi: {count}",
            ...
            "references_label": {
                ...
                "fr": "Liens de référence",
                "de": "Beleglinks",
            },
            "no_claims": {
                "en": "No claims were flagged.",
                "it": "Nessuna affermazione è stata segnalata.",
                "fr": "Aucune allégation signalée.",
                "de": "Keine Aussagen wurden markiert.",
            },
            "issue_default": {
                "en": "Issue",
                "it": "Problema",
            ...
            "importance_level": {
                ...
                "fr": "Importance {level}/5",
                "de": "Wichtigkeit {level}/5",
            },
            "why_flagged": {
                "en": "Why flagged",
                "it": "Perché segnalato",
            ...
            "edit_placeholder": {
                ...
                "fr": "Fournissez le texte de remplacement...",
                "de": "Ersatztext eingeben...",
            },
            "claim_source_quote": {
                "en": "Source passage",
            ...
            "review_stage": {
                "claims": {
                    ...
                    "fr": "Allégations clés extraites",
                    "de": "Zentrale Aussagen extrahiert",
                },
                "sources": {
                    "en": "Source existence checked",
                    "it": "Esistenza della fonte verificata",
                    "fr": "Existence de la source vérifiée",
                    "de": "Existenz der Quelle geprüft",
                },
                "support": {
                    "en": "Source support compared",
                    "it": "Coerenza con la fonte confrontata",
                    "fr": "Appui de la source comparé",
                    "de": "Inhaltliche Stützung durch die Quelle verglichen",
                },
                "logic": {
                    "en": "Logic reviewed",
                    "it": "Logica esaminata",
            ...
            "original_text": {
                ...
                "fr": "Texte de recherche original",
                "de": "Originaler Recherchetext",
            },
            "located_passage": {
                "en": "Located passage",
                "it": "Passaggio individuato",
                "fr": "Passage repere",
                "de": "Gefundene Passage",
            },
            "located_passage_note": {
                ...
                "fr": "Le fragment correspondant est affiche ci-dessous pour eviter de le chercher dans toute la zone de texte.",
                "de": "Der passende Ausschnitt wird unten sichtbar gemacht, damit Sie ihn nicht im gesamten Textfeld suchen muessen.",
            },
            "located_passage_range": {
                "en": "Lines {start}-{end} in the original text",
                "it": "Righe {start}-{end} nel testo originale",
                "fr": "Lignes {start}-{end} dans le texte source",
                "de": "Zeilen {start}-{end} im Originaltext",
            },
            "source_quote_missing": {
                ...
                "fr": "Aucun passage précis n'a été renvoyé pour cette allégation. Vérifiez directement le texte original et les liens.",
                "de": "Für diese Aussage wurde keine genaue Passage zurückgegeben. Prüfen Sie den Originaltext und die Links direkt.",
            },
            "claim_index": {
                "en": "Claim docket",
                "it": "Indice delle affermazioni",
                "fr": "Registre des allégations",
                "de": "Aussagenübersicht",
            },
            "claim_index_hint": {
                ...
                "fr": "Traitez une allégation à la fois tout en gardant visible l'ensemble de la revue.",
                "de": "Arbeiten Sie jeweils an einer Aussage, während die gesamte Prüfung sichtbar bleibt.",
            },
            "claim_filter": {
                "all": {
                    "en": "All",
            ...
            "summary": {
                "claims_extracted": {
                    ...
                    "fr": "Allégations extraites",
                    "de": "Extrahierte Aussagen",
                },
                "claims_attention": {
                    "en": "Claims needing review",
                    "it": "Affermazioni da rivedere",
                    "fr": "Allégations à revoir",
                    "de": "Zu prüfende Aussagen",
                },
                "issues_flagged": {
                    "en": "Issues flagged",
                    "it": "Problemi rilevati",
                    "fr": "Problèmes signalés",
                    "de": "Markierte Probleme",
                },
                "doc_ready": {
                    "en": "Validated doc",
                    "it": "Documento validato",
                    "fr": "Document validé",
                    "de": "Validiertes Dokument",
                },
            },
            "issue_status": {
                "incorrect": {
            ...
            "evidence_gate": {
                ...
                "fr": "Contrôle déterministe de la source",
                "de": "Deterministische Quellenprüfung",
            },
            "evidence_gate_note": {
                ...
                "fr": "Ce contrôle vérifie d'abord l'intégrité de la source. L'appui sémantique et le raisonnement sont examinés séparément ci-dessous.",
                "de": "Diese Prüfung kontrolliert zuerst die Integrität der Quelle. Inhaltliche Stützung und Begründung werden darunter getrennt geprüft.",
            },
            "evidence_gate_checked_url": {
                "en": "Checked source",
                "it": "Fonte verificata",
                "fr": "Source contrôlée",
                "de": "Geprüfte Quelle",
            },
            "evidence_gate_excerpt": {
                "en": "Matched source excerpt",
                "it": "Estratto della fonte trovato",
                "fr": "Extrait source retrouvé",
                "de": "Gefundener Quellenauszug",
            },
            ...
            "evidence_gate_step": {
                ...
                "source_quote_matched": {
                    "en": "Source passage matched",
                    "it": "Passaggio della fonte trovato",
                    "fr": "Passage source retrouvé",
                    "de": "Quellenpassage gefunden",
                },
            },
            "support_review": {
                "en": "Semantic support review",
                "it": "Verifica semantica del supporto",
                "fr": "Revue de l'appui sémantique",
                "de": "Prüfung der semantischen Stützung",
            },
            "support_review_note": {
                ...
                "fr": "Cette revue examine si la source étaye réellement l'allégation, pas seulement si le lien existe.",
                "de": "Diese Prüfung bewertet, ob die Quelle die eigentliche Aussage stützt und nicht nur, ob der Link existiert.",
            },
            "support_review_checked_url": {
                "en": "Source reviewed",
                "it": "Fonte esaminata",
                "fr": "Source examinée",
                "de": "Geprüfte Quelle",
            },
            "support_review_passage": {
                "en": "Supporting passage",
                "it": "Passaggio di supporto",
                "fr": "Passage d'appui",
                "de": "Stützende Passage",
            },
            "support_review_scope": {
                "en": "Support scope",
                "it": "Ambito del supporto",
                "fr": "Portée de l'appui",
                "de": "Umfang der Stützung",
            },
            "support_review_verdict": {
                "supported": {
                    "en": "Supported",
                    "it": "Supportata",
                    "fr": "Étayée",
                ...
                "partially_supported": {
                    ...
                    "fr": "Partiellement étayée",
                    "de": "Teilweise gestützt",
                },
                "not_supported": {
                    "en": "Not supported",
                    "it": "Non supportata",
            ...
            "support_review_scope_values": {
                "same_conclusion": {
                    "en": "Same conclusion",
                    "it": "Stessa conclusione",
                    "fr": "Même conclusion",
                    "de": "Gleiche Schlussfolgerung",
                },
                "same_fact": {
                    "en": "Same fact only",
                    "it": "Solo stesso fatto",
                    "fr": "Même fait seulement",
                    "de": "Nur gleicher Sachverhalt",
                },
                "related_context": {
                    "en": "Related context only",
                    "it": "Solo contesto collegato",
                    "fr": "Contexte connexe seulement",
                    "de": "Nur verwandter Kontext",
                },
                "unclear": {
                    "en": "Unclear",
                    "it": "Non chiaro",
            ...
            "reasoning_review": {
                ...
                "fr": "Revue du raisonnement",
                "de": "Prüfung der Begründung",
            },
            "reasoning_review_note": {
                ...
                "fr": "Cette revue contrôle la logique interne de l'allégation et, lorsque c'est pertinent, si les allégations reliées justifient la conclusion finale.",
                "de": "Diese Prüfung kontrolliert die interne Logik der Aussage und, soweit relevant, ob die verknüpften Aussagen die Schlussfolgerung tragen.",
            },
            "reasoning_logic": {
                "en": "Internal logic",
                "it": "Logica interna",
            ...
            "reasoning_recommended_improvements": {
                "en": "Suggested repair",
                "it": "Correzione suggerita",
                "fr": "Correction suggérée",
                "de": "Vorgeschlagene Korrektur",
            },
            "conclusion_review": {
                "en": "Conclusion support",
                "it": "Supporto della conclusione",
                "fr": "Appui de la conclusion",
                "de": "Stützung der Schlussfolgerung",
            },
            "conclusion_review_conclusion_id": {
                "en": "Conclusion ID",
                "it": "ID conclusione",
                "fr": "ID de conclusion",
                "de": "Schlussfolgerungs-ID",
            },
            "conclusion_review_linked_claims": {
                "en": "Linked claims reviewed",
                "it": "Affermazioni collegate esaminate",
                "fr": "Allégations reliées examinées",
                "de": "Geprüfte verknüpfte Aussagen",
            },
            "conclusion_review_relied_on_claims": {
                "en": "Claims relied on",
                "it": "Affermazioni utilizzate",
                "fr": "Allégations utilisées",
                "de": "Herangezogene Aussagen",
            },
            "conclusion_review_missing_step": {
                "en": "Missing step",
                "it": "Passaggio mancante",
                "fr": "Étape manquante",
                "de": "Fehlender Schritt",
            },
            "conclusion_review_recommended_fix": {
                "en": "Suggested narrowing",
                "it": "Riformulazione suggerita",
                "fr": "Reformulation suggérée",
                "de": "Vorgeschlagene Eingrenzung",
            },
            "conclusion_review_verdict": {
                "supported": {
                    "en": "Supported",
                    "it": "Supportata",
                    "fr": "Étayée",
            ...
            "claim_location": {
                "en": "Position in document: {value}",
                "it": "Posizione nel documento: {value}",
                "fr": "Position dans le document : {value}",
                "de": "Position im Dokument: {value}",
            },
            ...
            "claim_location_section_id": {
                "en": "Section ID: {id}",
                "it": "ID sezione: {id}",
                "fr": "ID section : {id}",
                "de": "Abschnitts-ID: {id}",
            },
            "claim_location_extraction_pass": {
                "en": "Extraction pass: {value}",
                "it": "Passaggio di estrazione: {value}",
                "fr": "Passage d'extraction : {value}",
                "de": "Extraktionsdurchlauf: {value}",
            },
            "extraction_pass": {
                "section": {
                    "en": "section",
            ...
            "risk_factor_templates": {
                ...
                "materiality": {
                    ...
                    "fr": "Matérialité : {value}",
                    "de": "Wesentlichkeit: {value}",
                },
            },
            "materiality": {
                "high": {
            ...
            "risk_factors": {
                "conclusion_linked": {
                    "en": "Linked to a conclusion",
                    "it": "Collegato a una conclusione",
                    "fr": "Lié à une conclusion",
                    "de": "Mit einer Schlussfolgerung verknüpft",
                },
                "no_support_refs": {
                    "en": "No supporting references",
                    "it": "Senza riferimenti di supporto",
                    "fr": "Sans références de support",
                    "de": "Keine stützenden Referenzen",
                },
                "citation_only_support": {
                    "en": "Citation-only support",
                    "it": "Supporto solo tramite citazioni",
                    "fr": "Support uniquement par citation",
                    "de": "Nur Zitat-basierte Stützung",
                },
                "high_model_confidence": {
                    "en": "High model confidence",
                    "it": "Alta confidenza del modello",
                    "fr": "Confiance élevée du modèle",
                    "de": "Hohe Modellkonfidenz",
                },
                "low_model_confidence": {
                    "en": "Low model confidence",
                    "it": "Bassa confidenza del modello",
                    "fr": "Faible confiance du modèle",
                    "de": "Niedrige Modellkonfidenz",
                },
            },
            "gravity": {
                "info": {
            ...
            "issue_kind": {
                ...
                "partially_supported_claim": {
                    "en": "Partially supported claim",
                    "it": "Affermazione parzialmente supportata",
                    "fr": "Allégation partiellement étayée",
                    "de": "Teilweise gestützte Aussage",
                },
                "link_irrelevant": {
                    "en": "Irrelevant link",
                    "it": "Link non pertinente",
                    "fr": "Lien non pertinent",
                    "de": "Irrelevanter Link",
                },
                "link_broken": {
                    "en": "Broken link",
                    "it": "Link non raggiungibile",
                    "fr": "Lien cassé",
                    "de": "Defekter Link",
                },
                "link_unreachable": {
                    "en": "Unreachable link",
                    "it": "Link non raggiungibile",
                    "fr": "Lien inaccessible",
                    "de": "Nicht erreichbarer Link",
                },
                "source_unavailable": {
                    "en": "Source unavailable",
                    "it": "Fonte non disponibile",
                    "fr": "Source indisponible",
                    "de": "Quelle nicht verfügbar",
                },
                "source_unparseable": {
                    "en": "Source unreadable",
                    "it": "Fonte non leggibile",
                    "fr": "Source illisible",
                    "de": "Quelle unlesbar",
                },
                "missing_link": {
                ...
                "reference_missing": {
                    "en": "Missing reference",
                    "it": "Riferimento mancante",
                    "fr": "Référence manquante",
                    "de": "Fehlende Referenz",
                },
                "reference_inaccurate": {
                    "en": "Inaccurate reference",
                    "it": "Riferimento impreciso",
                    "fr": "Référence imprécise",
                    "de": "Ungenaue Referenz",
                },
                "reference_irrelevant": {
                    "en": "Irrelevant reference",
                    "it": "Riferimento non pertinente",
                    "fr": "Référence non pertinente",
                    "de": "Irrelevante Referenz",
                },
                "citation_missing": {
                    "en": "Missing citation",
                    "it": "Citazione mancante",
                    "fr": "Citation manquante",
                    "de": "Fehlendes Zitat",
                },
                "citation_inaccurate": {
                    "en": "Inaccurate citation",
                    "it": "Citazione imprecisa",
                    "fr": "Citation imprécise",
                    "de": "Ungenaues Zitat",
                },
                "factual_error": {
                    "en": "Factual error",
                ...
                "unsupported_claim": {
                    ...
                    "it": "Affermazione non supportata",
                    "fr": "Allégation non étayée",
                    "de": "Nicht belegte Aussage",
                },
                "contradictory_claim": {
                    "en": "Contradictory claim",
                    "it": "Affermazione contraddittoria",
                    "fr": "Allégation contradictoire",
                    "de": "Widersprüchliche Aussage",
                },
                "reasoning_fallacy": {
                    "en": "Reasoning fallacy",
                    "it": "Errore di ragionamento",
                    "fr": "Erreur de raisonnement",
                    "de": "Fehlerhafte Argumentation",
                },
                "missing_inferential_step": {
                    "en": "Missing inferential step",
                    "it": "Passaggio inferenziale mancante",
