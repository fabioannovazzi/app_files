...
LANDING_CONTENT: Dict[str, Dict[str, Any]] = {
    "en": {
        ...
        "compliance": {
            ...
            "closing": "Less data in the LLM context. No additional data-processing intermediary. A simpler compliance perimeter.",
            "cta_label": "See how your data is handled",
            "cta_href": "/data-handling",
        },
        "bridge": {
    ...
    "it": {
        ...
        "compliance": {
            ...
            "closing": "Meno dati nel contesto dell'LLM. Nessun intermediario aggiuntivo nel trattamento dei dati. Un perimetro di conformità più semplice.",
            "cta_label": "Scopri come vengono gestiti i tuoi dati",
            "cta_href": "/data-handling",
        },
        "bridge": {
    ...
    "fr": {
        ...
        "compliance": {
            ...
            "closing": "Moins de données dans le contexte du LLM. Aucun intermédiaire supplémentaire dans le traitement des données. Un périmètre de conformité plus simple.",
            "cta_label": "Voir comment vos données sont traitées",
            "cta_href": "/data-handling",
        },
        "bridge": {
    ...
    "de": {
        ...
        "compliance": {
            ...
            "closing": "Weniger Daten im LLM-Kontext. Keine zusätzliche Stelle in der Datenverarbeitung. Ein einfacherer Compliance-Rahmen.",
            "cta_label": "Erfahren Sie, wie Ihre Daten verarbeitet werden",
            "cta_href": "/data-handling",
        },
        "bridge": {
...
def create_app() -> FastAPI:
    ...
    async def _unhandled_exception_handler(request: Request, exc: Exception):
        ...
        LOGGER.exception(
            "Unhandled API exception error_id=%s method=%s path=%s query=%s",
            error_id,
            request.method,
            request.url.path,
            query_text,
