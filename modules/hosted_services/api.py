...
# Product-card leads are stable positioning, not a live inventory of skills.
# New skills belong on the detailed product pages and must not rewrite these leads.
            ...
            "principles": [
                {
                    ...
                    "blurb": "Filtri e aggregazioni possono essere eseguiti sul tuo computer quando rendono il lavoro più efficace. Clara, Vera e Lucia non anonimizzano i dati perché possono essere utili al lavoro professionale.",
                },
                {
