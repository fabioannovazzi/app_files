...
from modules.hosted_services.api import _get_landing_page_content
...
def test_homepage_content_states_the_llm_context_boundary_honestly() -> None:
    ...
    assert content["lead"] == (
        "Professional work may require the selected AI workspace to read real client "
        "data."
    )
    ...
    assert "AI workspace the user chooses" in content["description"]
    ...
    assert "Ordinary plugin functions use the AI workspace the user chooses" in (
...
@pytest.mark.parametrize(
    ...
    (
        ...
        (
            ...
            "ambiente AI scelto dall'utente",
        ...
        (
            ...
            "environnement d'IA choisi par l'utilisateur",
        ...
        (
            ...
            "vom Nutzer gewählten KI-Arbeitsumgebung",
...
def test_homepage_localizes_the_two_category_data_boundary(
    ...
    assert ai_workspace in content["description"]
