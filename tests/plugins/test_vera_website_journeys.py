...
def test_vera_italian_directory_names_the_professional_task_and_object() -> None:
    ...
    expected_labels = [
        ...
        "Preparazione della richiesta per una ricerca legale e fiscale",
    ...
    expected_runtime_labels = {
        ...
        "module.newClient.includes.data": "Estrazione dei dati fiscali dai documenti",
        ...
        "module.variance.title": "Analisi degli scostamenti",
        ...
        "module.prompt.title": "Preparazione della richiesta per una ricerca legale e fiscale",
        "module.research.title": "Verifica delle fonti e delle conclusioni della ricerca",
    }

    # Compact marketplace labels remain a separate mechanically verifiable contract.
...
def test_vera_missing_guide_pack_is_complete_youtube_source() -> None:
    ...
    for language, required_phrases in {
        "it": (
            ...
            "lavora meglio con Codex",
            "continuare la conversazione in ChatGPT",
        ),
        "en": (
            "private index",
            ...
            "works better with Codex",
            "continue the conversation in ChatGPT",
        ),
        "fr": (
            "index privé",
            ...
            "fonctionne mieux avec Codex",
            "poursuivre la conversation dans ChatGPT",
        ),
        "de": (
            "privaten Index",
            ...
            "arbeitet Vera besser mit Codex",
            "Unterhaltung in ChatGPT fortsetzen",
        ),
        "es": (
            "índice privado",
            ...
            "funciona mejor con Codex",
            "continuar la conversación en ChatGPT",
        ),
    }.items():
