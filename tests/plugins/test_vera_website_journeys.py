...
def test_vera_italian_directory_matches_marketplace_capability_names() -> None:
    ...
    expected_labels = [
        ...
        "Piano economico-finanziario e fabbisogno",
        "Analisi scostamenti",
    ...
    expected_runtime_labels = {
        ...
        "module.businessPlanning.title": "Piano economico-finanziario e fabbisogno",
    ...
    canonical_skill_labels = {
        ...
        "business-planning": "Piano economico-finanziario e fabbisogno",
