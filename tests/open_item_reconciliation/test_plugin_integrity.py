...
PLUGIN = ROOT / "plugins" / "open-item-reconciliation"
...
def test_plugin_manifest_and_marketplace_entry_are_valid():
    ...
    assert manifest["name"] == "open-item-reconciliation"
...
def test_plugin_beta_onboarding_and_prompt_bank_are_documented():
    ...
    skill = (PLUGIN / "skills" / "open-item-reconciliation" / "SKILL.md").read_text(
        encoding="utf-8"
    )
