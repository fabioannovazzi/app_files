...
- Twelve focused file-integrity tests and 37 existing customer-ledger tests pass.
  ...
  exact binary copying and hashing. Mutation tests cover both timestamp observations,
